                                    ...
                                    <div class="table-responsive-sm w-table">
                                        <table class="table " style="width: 1500px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-td"><img class="img-list-products-large"
                                                                          src="<%out.print(mapHaAndSps.get(sanPham.getIdSP()));%>"
                                                                          alt=""></td>
                                                ...
                                                <td class="table-td"><%
                                                    out.print(mapCaAndSps.get(sanPham.getIdSP()));%></td>
                                                ...
                                                <td class="table-td button-td">
                                                    <button class="btn btn-primary">
                                                        <a href="/shopbantrong_war/admin-product-update?idsp=<%out.print(sanPham.getIdSP());%>">Edit</a>
                                                    </button>

                                                    <a class="btn btn-danger"
                                                       style="color: white; width: 100%; height: 100%"
                                                       onclick="return confirm('Bạn muốn xóa sản phẩm ? <%out.print( sanPham.getIdSP()+" : "+sanPham.getTenSP());%>');"
                                                       href="/shopbantrong_war/admin-product-delete?idsp=<%out.print(sanPham.getIdSP());%>">Delete
                                                    </a>
