                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                          ...
                                          <div class="contact_inner">
                                             <div class="left">
                                                ...
                                                <ul class="list-unstyled">
                                                   <li><i class="fa fa-envelope-o"></i> : ATuan@gmail.com</li>
                                                   <li><i class="fa fa-phone"></i> : 098 788 3210</li>
                                                </ul>
                                             </div>
                                             <div class="right">
                                    ...
                                    <!-- end column contact blog -->
                                     ...
                                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 profile_details margin_bottom_30">
                                       <div class="contact_blog">
                                          ...
                                          <div class="contact_inner">
                                             <div class="left">
                                                <h3 >Trương Quang Thịnh</h3>
                                                <p><strong>Chuyên môn: </strong>FullStack Developer</p>
                                                <ul class="list-unstyled">
                                                   <li><i class="fa fa-envelope-o"></i> : QThinh@gmail.com</li>
                                                   <li><i class="fa fa-phone"></i> : 098 788 3210</li>
                                                </ul>
                                             </div>
                                             <div class="right">
                                    ...
                                    <!-- end column contact blog --> <!-- column contact --> 
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 profile_details margin_bottom_30">
                                       <div class="contact_blog">
                                          <!-- <h4 class="brief">Digital Strategist</h4> -->
                                          <div class="contact_inner">
                                             <div class="left">
                                                ...
                                                <p><strong>Chuyên môn: </strong>FullStack Developer</p>
                                                <ul class="list-unstyled">
                                                   <li><i class="fa fa-envelope-o"></i> : TrongTin@gmail.com</li>
                                                   <li><i class="fa fa-phone"></i> : 098 788 3210</li>
                                                </ul>
                                             </div>
                                             <div class="right">
