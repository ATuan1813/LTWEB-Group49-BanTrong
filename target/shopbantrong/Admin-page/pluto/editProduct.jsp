                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12">
                                        <form action="" class="tm-edit-product-form">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="name" name="name" value="Pearl Session Studio Select 22″ 4 Piece Shell Pack – Gloss Barnwood" type="text" class="form-control validate"
                                                    required />
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="description">Mô Tả</label>
                                                <textarea class="form-control validate" rows="9" required>Chín muồi với cảm giác cổ điển, Session Studio Select tạo nên sự cân bằng âm nhạc mạnh mẽ giữa sự ấm áp và đột phá. Âm thanh cao cấp của Pearl được chế tạo đặc biệt cho thu âm phòng thu. Những chiếc trống này cung cấp nhiều tính năng đột phá thường chỉ có trên bộ dụng cụ cấp độ Pearl’s Masters với mức giá cạnh tranh nghiêm túc.</textarea>
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="description">Thông Số Kỹ Thuật</label>
                                                <textarea class="form-control validate" rows="4" required>10″ x 7″ Tom, 12″ x 8″ Tom, 16″ x 16″ Floor tom, 22″ x 16″ Bass drum</textarea>
                                            </div>
                                            <div class="row">
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    ...
                                                    <select class="custom-select tm-select-accounts" id="category">
                                                        ...
                                                        <option value="1" selected>Shell pack</option>
                                                ...
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    ...
                                                    <select class="custom-select tm-select-accounts" id="category">
                                                        ...
                                                        <option value="1" selected>Đỏ</option>
                                            ...
                                            <div class="row">
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    ...
                                                    <select class="custom-select tm-select-accounts" id="category">
                                                        ...
                                                        <option value="3" selected>Roland</option>
                                                ...
                                                <select class="custom-select tm-select-accounts" id="category">
                                                    ...
                                                    <option value="3" selected>Sản Phẩm Mới </option>
                                            ...
                                            <div class="row">
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    ...
                                                    <input id="expire_date" value="39" name="expire_date" type="text"
                                                        class="form-control validate" data-large-mode="true" />
                                                </div>
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    <label for="stock">Sale
                                                    </label>
                                                    <input id="stock" value="39%" name="stock" type="text"
                                            ...
                                            <div class="row">
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    ...
                                                    <input id="expire_date" value="39.000.000 vnd" name="expire_date" type="text"
                                                        class="form-control validate" data-large-mode="true" />
                                                </div>
                                                <div class="form-group mb-3 col-xs-12 col-sm-6">
                                                    <label for="stock">Vật Liệu
                                                    </label>
                                                    <input id="stock" value="Nhôm" name="stock" type="text"
                                                        class="form-control validate" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                                                <div class="tm-product-img-dummy mx-auto" id="img-pre">
                                                    <!-- <i class="fas fa-cloud-upload-alt tm-upload-icon"
                                                        ...
                                                        <img id="nameImg" src="/durmshop/assets/img/product2/template1/template3.png" alt="" class="img-pre__img">
